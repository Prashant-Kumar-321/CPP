...
class Child: public Parent // Inheriting Parent class publically in Child class 
{
  ...
  public: 
    ...
    void display() //function overriding of parent class 
    {
      Parent::display(); // calling overridden fucntion from child class 
...
int main()
{
  ...
  /**********************************************************************************************************************************/
  //##############  Accessing Overriden function of Parent clas   ############### 
 ...
 // !*@* child class *ptr cann't point the parent object !*@*
